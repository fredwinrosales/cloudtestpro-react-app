<h1 className="text-5xl font-bold text-red-500 text-center mt-10">Test de Tailwind</h1>
...
export default function App() {
  ...
  return (
    <div className="absolute inset-0 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 opacity-70 -z-10">
      {/* Header */}
